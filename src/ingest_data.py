...
class ZipDataIngestor(DataIngestor):
    def ingest(self, file_path: str) -> pd.DataFrame:
        ...
        if len(csv_files) > 1:
            raise ValueError("Multiple CSV found.Please specify which one to use.")
...
#Implement a Factory to create DataIntegers
...
#Specify the file path
    file_path = r"C:\Users\User\Desktop\house prediction\data\archive.zip"

#Determine the file extension
    file_extension = os.path.splitext(file_path)[1]

#Get the apropriate DataIngestor
